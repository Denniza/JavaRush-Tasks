    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock stock, Stock t1) {
                ...
                return ((Date) t1.get("date")).compareTo((Date)stock.get("date"));
            }
        }).thenComparing(new Comparator<Stock>() {
            @Override
            public int compare(Stock stock, Stock t1) {
                ...
                if (stock.containsKey("change"))
                    ...
                    profit = (double)stock.get("last") - (double) stock.get("open");

                double profit2;
                if(t1.containsKey("change"))
                    profit2 = (double)t1.get("change");
                else
                    profit2 = (double)t1.get("last");

                if((profit - profit2) >=0) return -1;
                else return 1;
            }
        }));
    }
